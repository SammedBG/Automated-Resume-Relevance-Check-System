...
def apply_custom_css():
    """Apply modern, professional UI styling"""
    st.markdown("""
    <style>
    /* Import modern fonts */
    ...
    .success-card {
        ...
        box-shadow: 0 8px 25px rgba(46, 213, 115, 0.2) !important;
    }
...
def main():
    ...
    <div class="main-header">
        ...
        <div style="margin-top: 1.5rem; display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
            <span style="background: rgba(255,255,255,0.2); padding: 0.5rem 1rem; border-radius: 25px; font-size: 0.9rem; color: white; backdrop-filter: blur(10px);">✨ Smart Analysis</span>
            <span style="background: rgba(255,255,255,0.2); padding: 0.5rem 1rem; border-radius: 25px; font-size: 0.9rem; color: white; backdrop-filter: blur(10px);">🚀 Fast Processing</span>
            <span style="background: rgba(255,255,255,0.2); padding: 0.5rem 1rem; border-radius: 25px; font-size: 0.9rem; color: white; backdrop-filter: blur(10px);">📊 Detailed Reports</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        <div class="modern-card" style="margin-bottom: 1rem;">
            <h3 style="color: #2c3e50; margin: 0; font-weight: 700; display: flex; align-items: center; gap: 0.5rem;">
                <span style="font-size: 1.2rem;">🧭</span> Navigation
            </h3>
            <p style="margin: 0.5rem 0 0 0; color: #7f8c8d; font-size: 0.9rem;">Choose a page</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
        <div class="modern-card" style="margin-bottom: 1rem;">
            <h4 style="color: #2c3e50; margin: 0; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
                <span style="font-size: 1.1rem;">⚙️</span> Processing Configuration
            </h4>
            <p style="margin: 0.5rem 0 0 0; color: #7f8c8d; font-size: 0.9rem;">Configure processing options</p>
        </div>
        """, unsafe_allow_html=True)
...
def upload_page():
    ...
    <div class="modern-card">
        <h2 style="color: #2c3e50; margin: 0; font-weight: 700; display: flex; align-items: center; gap: 0.5rem;">
            <span style="font-size: 1.5rem;">📤</span> Upload & Process Resumes
        </h2>
        <p style="margin: 0.5rem 0 0 0; color: #7f8c8d;">Upload job descriptions and resumes for AI-powered analysis</p>
    </div>
    """, unsafe_allow_html=True)
...
def process_resumes(resumes, job_description):
    ...
    try:
        ...
        # Enhanced completion message with modern styling
        status_text.markdown("""
        <div class="processing-status">
            <div style="font-size: 3rem; margin-bottom: 1rem;">🎉</div>
            <h3 style="margin: 0; font-size: 1.5rem;">Processing Completed Successfully!</h3>
            <p style="margin: 0.5rem 0 0 0; opacity: 0.9;">All resumes have been analyzed successfully</p>
        </div>
        """, unsafe_allow_html=True)
